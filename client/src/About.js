  ...
  return (
    <div class="card w-75 mx-auto bg-light border-warning " style={{ marginTop: 50, padding: 20, paddingLeft: 40, paddingRight: 40, backgroundColor: "#DFC98A" }}>
      <div class="card-body text-center" >
        ...
        <br></br>
        <br></br>
        By his own choosing, Greg was a blood, organ and tissue donor. Transplants of his heart, lungs, liver and kidneys have already helped saved the lives of four individuals, and one person has been given the gift of sight from his eye donation. Medical research and potentially hundreds of lives will also benefit from his tissue, nerve, bone and cell donations.</p>
      </div>
    </div>
  );
}
