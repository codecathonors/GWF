    ...
    return (
        ...
        <nav class="navbar navbar-light">
            ...
            <div class="d-grid mx-auto" style={{ fontSize: 14, letterSpacing: 1}}>
                <a class="navbar-text text-decoration-none">©2014, The Gregory Weiner Foundation | <a href="/contact-us" class="text-decoration-none">Contact Us</a> | <a href="/site-disclaimer" class="text-decoration-none">Site Disclaimer</a> | <a class="nav-item" onClick={handleFacebookClick}>
