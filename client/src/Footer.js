...
function Footer() {
    ...
    function handleSiteDisclaimerClick(e) {
        e.preventDefault()
        window.location.replace("/site-disclaimer")
    }


    return (
        <>
        <nav class="navbar absolute-bottom navbar-light">
                <div class="container-fluid footer navbar-fixed-bottom" style={{
          position: "fixed",
          padding: 8,
          left: 0,
          bottom: 0,
        ...
        backgroundColor: "#ffb94e"
                ...
                <a class="navbar-brand" href="/">©2014, The Gregory Weiner Foundation</a>
                    <button type="button" class="btn btn-primary" onClick={handleContactUsClick}>
                    Contact Us
                </button>
                
               
                    <button type="button" class="btn btn-primary" onClick={handleSiteDisclaimerClick}>Site Disclaimer</button> 
                ...
                <a class="nav-item"><button class="btn btn-primary" onClick={handleAmazonClick}>
